...
//		
//		
//		String fileName = "H:\\Users\\sunpx\\Desktop\1.jpg";
//		byte[] source = Base64Utils.fileToByte(fileName);
//		
//		byte[] data = RSAUtils.encryptByPublicKey(source, publicKey);
//		System.out.println("加密后:" + data);
//		byte[] buff = RSAUtils.decryptByPrivateKey(data, privateKey);
...
//		System.err.println("��Կ���ܡ���˽Կ����");
//		String source = "tttttttttttttttttttttttttttttt";
//		System.out.println("源数据:\r\n" + source);
//		byte[] data = source.getBytes();
//		byte[] encodedData = RSAUtils.encryptByPublicKey(data, publicKey);
//		System.out.println("加密后:\r\n" + new String(encodedData));
//		System.out.println("----------------:base64����" + Base64Utils.encode(encodedData));
...
//		String data = "��ð�������ʦ��s 223 1@324234234sfsfsf";
//		data = RSAUtils.encryptedDataOnJava(data, PUBLICKEY);
//		System.out.println("�������ݣ�" + data);
//
//		System.out.println("�������ݣ�" + RSAUtils.decryptDataOnJava(data, PRIVATEKEY));
//	}
//
